...
export class ProfesoresTablaParamComponent implements OnInit, OnChanges {
  ...
  columnas: string[] = ['profesorNro', 'nombreCompleto', 'telefono', 'email', 'formacion', 'titulo', 'opciones'];
  // Output
