...
export class SeguimientoFormComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    ...
    this.form = this._fb.group({
      ...
      tipoSeguimiento: [null, [Validators.required, Validators.minLength(7), Validators.maxLength(300)]],
      resuelto: [null, []],
      observacion: [null, [Validators.required, Validators.minLength(7), Validators.maxLength(300)]],
      observacion2: [null, [Validators.minLength(7), Validators.maxLength(300)]],
      observacionJefe: [null, [Validators.minLength(7), Validators.maxLength(300)]],
